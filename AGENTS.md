...
- Cloudflare deploy:
  ...
  - unified mode defaults: `CF_WORKERS_BUILDS_AUTO_DEPLOY=0`, `CF_ALLOW_LEGACY_DEPLOY_HOOKS=0`
  - set `ALLOW_REMOTE_DEPLOY_TRIGGER=1` only if you intentionally want remote/API-triggered deploys
- Admin auth:
