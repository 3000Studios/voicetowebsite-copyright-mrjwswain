  ...
  return (
    <div className={`${className} relative group transition-all duration-700 hover:rotate-[360deg]`}>
      <svg
        ...
        className="w-full h-full drop-shadow-[0_0_30px_rgba(0,229,255,0.4)]"
      >
        <defs>
        ...
        <path
          d="M256 160 Q210 160 210 210 Q210 260 256 260 Q302 260 302 210 Q302 160 256 160 Z"
          fill="url(#scorp-metal)"
        />
        <path
          d="M220 230 Q180 230 160 260 Q140 290 150 310"
          stroke="url(#scorp-metal)"
          strokeWidth="12"
          fill="none"
          strokeLinecap="round"
        />
        <path
          d="M292 230 Q332 230 352 260 Q372 290 362 310"
          stroke="url(#scorp-metal)"
          strokeWidth="12"
          fill="none"
          strokeLinecap="round"
        ...
        {/* Claws */}
        <path
          d="M150 310 L130 340 M150 310 L170 340"
          stroke="url(#scorp-metal)"
          strokeWidth="8"
          strokeLinecap="round"
        />
        <path
          d="M362 310 L342 340 M362 310 L382 340"
          stroke="url(#scorp-metal)"
          strokeWidth="8"
          strokeLinecap="round"
        />
        ...
        {/* Tail Arc */}
        <path
          d="M256 160 Q256 60 380 80 Q450 100 420 180"
          stroke="url(#scorp-metal)"
          strokeWidth="15"
          fill="none"
          strokeLinecap="round"
        ...
        />
        <path
          d="M420 180 L440 160 L450 140 M420 180 L445 190"
          stroke="#00e5ff"
          strokeWidth="6"
          filter="url(#neon-glow)"
        />
