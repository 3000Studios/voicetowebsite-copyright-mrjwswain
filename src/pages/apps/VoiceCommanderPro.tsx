    ...
    <div className="voice-commander-pro">
      ...
      <div className="hero-section">
        ...
        <p className="hero-subtitle">
          The world's most advanced voice-to-code system. Write, edit, and
          deploy code using only your voice.
        </p>
      ...
      >
        {activeTab === "overview" && (
          <>
            ...
            >
              Voice Commander Pro is the revolutionary tool that allows
              developers to write code at the speed of thought. Using advanced
              AI and natural language processing, it understands your intent and
            ...
            <div className="features-grid">
              <div className="feature-card">
                ...
                <p className="feature-description">
                  Advanced machine learning models understand context and
                  generate optimal code solutions.
                </p>
              </div>
              <div className="feature-card">
                <div className="feature-icon">🌍</div>
                ...
                <p className="feature-description">
                  Support for all major programming languages including Python,
                  JavaScript, TypeScript, Go, Rust, and more.
                </p>
              </div>
              <div className="feature-card">
                <div className="feature-icon">⚡</div>
                ...
                <p className="feature-description">
                  Automatic syntax checking and error correction as you speak,
          ...
          <>
            ...
            <div className="features-grid">
              <div className="feature-card">
                ...
                <p className="feature-description">
                  Speak naturally and watch your words transform into code. No
                  need to memorize special commands.
                </p>
              </div>
              <div className="feature-card">
                <div className="feature-icon">🔧</div>
                ...
                <p className="feature-description">
                  Works seamlessly with VS Code, IntelliJ, Sublime Text, and all
                  major IDEs.
                </p>
              </div>
              <div className="feature-card">
              ...
              <div className="feature-card">
                ...
                <p className="feature-description">
                  AI suggests completions as you speak, learning your coding
                  style over time.
                </p>
              </div>
              <div className="feature-card">
                ...
                <p className="feature-description">
                  All processing happens locally. Your code never leaves your
                  machine.
                </p>
              </div>
              <div className="feature-card">
          ...
          <>
            ...
            <div className="testimonial">
              <p className="testimonial-text">
                "Voice Commander Pro has completely changed how I code. I can
                now write complex algorithms while pacing around my office. My
                productivity has increased by 300%."
              </p>
              <p className="testimonial-author">
                — Sarah Chen, Senior Software Engineer @ Google
              </p>
            </div>
            <div className="testimonial">
              <p className="testimonial-text">
                "As someone with RSI, this tool has been a lifesaver. I can
                continue doing what I love without pain. The AI is incredibly
                accurate."
              </p>
              <p className="testimonial-author">
            ...
            <div className="testimonial">
              <p className="testimonial-text">
                "I was skeptical at first, but after trying the demo, I was
                blown away. The natural language understanding is phenomenal.
                Worth every penny."
              </p>
              <p className="testimonial-author">
                — Emily Watson, CTO @ TechStartup Inc
              </p>
            </div>
