  ...
  return (
    <div className="relative overflow-hidden bg-black">
      ...
      <div className="relative z-10">
        ...
        <section id="generator" className="section-shell pt-8">
          <div className="content-grid">
            <div className="section-intro mb-10 max-w-4xl">
        ...
        <section id="how-it-works" className="section-shell">
          <div className="content-grid gap-16">
            <div className="section-intro max-w-3xl">
              ...
              <p className="section-copy">
                A frictionless 3-step experience distilled into one scrolling
                strip.
              </p>
            </div>
        ...
        <section className="section-shell">
          <div className="content-grid gap-16 lg:grid-cols-[1fr_1fr] items-start">
            ...
            >
              ...
              <p className="section-copy">
                VoiceToWebsite was born from a simple belief: every business
                owner deserves a beautiful, professional website without the
                technical barriers. We're not just building sites—we're building
                confidence, one voice command at a time.
              </p>
            ...
            >
              <div className="bg-[#0f172a] border border-white/10 rounded-2xl p-8 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <blockquote className="text-white/80 italic leading-relaxed">
                    "I built VoiceToWebsite because I was tired of seeing
                    talented entrepreneurs struggle with complex website
                    builders. Your business deserves to be online in minutes,
                    not weeks."
                  </blockquote>
                  <div className="mt-6 pt-6 border-t border-white/10">
                    <p className="text-sm text-white/50">
                      Backed by 3000 Studios — a digital innovation lab focused
                      on AI-powered tools that actually work.
                    </p>
                  </div>
                </div>
              </div>
              <div className="mt-6 grid gap-4 sm:grid-cols-3">
                {[
                  "/videos/referral.mp4",
                  "/videos/voice-to-website-demo.mp4",
                  "/videos/black-woman-demo.mp4",
                ].map((src, index) => (
                  <motion.div
                    key={src}
        ...
        <section id="faq" className="section-shell">
          <div className="content-grid gap-16 lg:grid-cols-[0.7fr_1.3fr]">
            <div className="section-intro">
              ...
              <p className="section-copy">
                Everything you need to know about the generation and hosting
                flow.
              </p>
            </div>
