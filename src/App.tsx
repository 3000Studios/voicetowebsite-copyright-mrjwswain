...
const App: React.FC = () => {
  ...
  return (
    <div
      className="relative w-screen h-screen bg-black select-none cursor-none overflow-hidden"
    ...
    >
      ...
      {phase === "home" && (
        ...
        >
          <div
            className={`w-2 h-2 rounded-full shadow-[0_0_8px] ${isBoltsEnabled ? "bg-cyan-500 shadow-cyan-500 animate-pulse" : "bg-white/20 shadow-white/10"}`}
          />
              ...
              >
                <div className="relative flex-1 flex items-center justify-center overflow-hidden bg-black/40">
                  ...
                  >
                    ...
                    <div
                      className={`absolute inset-0 transition-all duration-700 ${isHovered ? "bg-transparent" : "bg-black/60"}`}
                    />
