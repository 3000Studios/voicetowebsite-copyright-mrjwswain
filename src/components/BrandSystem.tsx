...
const orbs = [
  "-left-32 top-20 h-120 w-120 bg-cyan-400/18",
  "-right-40 top-88 h-136 w-136 bg-indigo-500/20",
  "left-[22%] -bottom-48 h-112 w-md bg-fuchsia-500/12",
];
...
export const BrandWallpaper = ({ density = "default" }: { density?: "default" | "quiet" }) => {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-20 overflow-hidden bg-(--vtw-canvas)">
      ...
      <div className="absolute inset-0 opacity-[0.16] bg-[linear-gradient(rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.05)_1px,transparent_1px)] bg-size-[72px_72px] mask-[radial-gradient(circle_at_top,black,transparent_72%)]" />
      <div className="absolute inset-0 opacity-[0.11] bg-[linear-gradient(115deg,transparent_0_48%,rgba(53,226,255,0.22)_49%,transparent_51%)] bg-size-[160px_160px]" />
      <div className="absolute inset-[-20%] opacity-[0.14] bg-[repeating-radial-gradient(circle_at_50%_50%,rgba(53,226,255,0.22)_0_1px,transparent_2px_24px)] bg-size-[220px_220px] animate-[wallpaper-spin_58s_linear_infinite]" />
