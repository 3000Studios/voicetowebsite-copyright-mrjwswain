        ...
        >
          ...
          <div className="grid grid-cols-6 gap-4 p-6 border-b border-white/10 bg-white/5">
            ...
            <div className="text-center">
              <div className="w-10 h-10 rounded-lg bg-linear-to-br from-indigo-500 to-purple-500 flex items-center justify-center mx-auto mb-2">
          ...
          {Object.entries(featureLabels).map(
            ([key, { label, icon: Icon }], index) => (
              <motion.div
                ...
                className="grid grid-cols-6 gap-4 p-4 border-b border-white/5 hover:bg-white/2 transition-colors"
              >
          ...
          {[
            {
              ...
              description:
                "The only platform that builds sites from voice descriptions. No typing, no templates to browse.",
              icon: Mic,
            },
            {
              title: "Full Code Ownership",
              description:
                "Export clean React/Next.js code and host anywhere. No vendor lock-in, ever.",
              icon: Code2,
            },
            {
              title: "2-Minute Generation",
              description:
                "From voice to live site faster than any competitor. Optimized AI pipeline delivers instantly.",
              icon: Zap,
            },
          ].map((advantage, index) => (
            <motion.div
