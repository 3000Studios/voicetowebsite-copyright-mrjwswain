...
export const ChatBot = () => {
  ...
  >([
    {
      role: "bot",
      content:
        "Hello, how can I help you today? I can help you build an empire, or just tell you a joke about websites.",
    },
  ]);
  ...
  const answers: Record<string, string> = {
    ...
    empire:
      "Building an empire starts with a single voice command. Just speak, and I'll build the rest.",
    "who are you":
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      let botResponse =
        "That's a deep thought. Let me prepare an answer for you soon. For now, try asking about 'pricing', 'empire', or a 'joke'.";
  ...
  return (
    <div className="fixed bottom-8 right-8 z-100">
            ...
            <div className="w-[380px] bg-slate-900/90 backdrop-blur-3xl rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
              <div className="bg-slate-950/50 p-6 flex items-center justify-between border-b border-white/5">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white font-black uppercase italic tracking-tight text-3d">
                    VoiceToWebsite AI
                  </span>
                </div>
                <button
              ...
              <div className="h-[400px] overflow-y-auto p-6 space-y-4 custom-scrollbar">
                {messages.map((msg, i) => (
                  ...
                  >
                    <div
                      className={`max-w-[80%] p-4 rounded-2xl text-sm font-medium italic ${
                        msg.role === "bot"
      ...
      >
        ...
        {!isOpen && (
          <span className="text-[10px] font-black uppercase tracking-[0.2em] mt-1 relative z-10">
            Chat
          </span>
        )}
      </motion.button>
