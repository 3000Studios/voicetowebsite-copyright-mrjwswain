...
export default function Checkout({ items, onClose }: CheckoutProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    trackRevenueEvent("checkout_submitted", {
      provider: "stripe",
      items: itemIds,
      total,
    }, total);
  ...
  useEffect(() => {
    trackRevenueEvent("checkout_modal_opened", {
      items: itemIds,
      total,
    }, total);
    return () => {
      trackRevenueEvent("checkout_modal_closed", {
        items: itemIds,
        total,
      }, total);
    };
        ...
        const button = paypalAny.Buttons({
          ...
          onApprove: async (data: any) => {
            ...
            try {
              ...
              console.error(err);
              trackRevenueEvent("checkout_failed", {
                provider: "paypal",
    ...
    <div className="checkout-modal">
      ...
      >
        <button
          ...
          onClick={() => {
            trackRevenueEvent("checkout_close_clicked", {
              items: itemIds,
              total,
            }, total);
            onClose();
            ...
            <div className="payment-methods">
              <button
                ...
                onClick={() => {
                  ...
                  trackRevenueEvent("payment_method_selected", {
                    method: "stripe",
                    items: itemIds,
                    total,
                  }, total);
