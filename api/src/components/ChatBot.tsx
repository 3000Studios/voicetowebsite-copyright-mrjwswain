...
export const ChatBot = () => {
  ...
  const answers: Record<string, string> = {
    ...
    'empire': "Building an empire starts with a single voice command. Just speak, and I'll manifest the rest.",
    'who are you': "I am the VoiceToWebsite AI. I'm like a genie, but instead of a lamp, I live in your browser and I don't grant wishes—I manifest digital realities.",
    'price': "Our plans start at $19.99/mo. It's a small price to pay for digital dominance.",
    'help': "I can help you with pricing, features, or just keep you company while you manifest your vision.",
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      let botResponse = "That's a deep thought. Let me manifest an answer for you soon. For now, try asking about 'pricing', 'empire', or a 'joke'.";
