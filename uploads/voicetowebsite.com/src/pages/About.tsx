    ...
    <div className="min-h-screen px-6 lg:px-24">
      <div className="max-w-7xl mx-auto pt-40 pb-20">
        <div className="mb-40 space-y-12">
          <span className="subheading text-indigo-500 font-bold">The Protocol // Origins</span>
          <motion.h1 
          ...
          <p className="text-3xl text-slate-400 max-w-3xl font-light italic leading-relaxed opacity-60">
            ...
            should be as thin as a spoken word. Neural Architect is pioneering the 
            next generation of the web.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-24 mb-60 items-center">
          <div className="relative aspect-square grayscale border border-white/5 bg-white/[0.02]">
            <Logo3D className="w-full h-full opacity-40" />
            <div className="absolute inset-0 grid-structure opacity-20" />
          </div>
          <div className="space-y-12">
            <h2 className="text-6xl font-bold tracking-tighter uppercase italic leading-none">Redefining <br /> Creation.</h2>
            <div className="space-y-8">
              <p className="text-xl font-light italic leading-relaxed opacity-60">
                Founded in 2024, Neural Architect started with a simple question: 
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-px bg-white/5 border border-white/5">
          {[
            ...
            <div key={i} className="p-16 bg-[#080808] space-y-6">
              <div className="text-4xl font-display italic tracking-tight">{stat.title}</div>
              <div className="text-[9px] font-black uppercase tracking-[0.4em] opacity-40">{stat.desc}</div>
            </div>
          ))}
        </div>
      </div>
