/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 42cc7d838e52a9b59a8f72f37051c72b)
// Runtime types generated with workerd@1.20260305.0 2026-03-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "BotHubDO" | "DeployControllerDO" | "LiveRoomDO" | "AuditLogDO";
	}
	interface Env {
		KV: KVNamespace;
		VTW_CACHE: KVNamespace;
		R2: R2Bucket;
		D1: D1Database;
		AI: Ai;
		ASSETS: Fetcher;
		...
		CACHE_CONTROL_HTML: "public, max-age=600";
		CF_WORKERS_BUILDS_AUTO_DEPLOY: string;
		ALLOW_REMOTE_DEPLOY_TRIGGER: string;
		VOICETOWEBSITE_WORKERS_BUILD_TOKEN: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		CF_ZONE_ID: string;
		CONTROL_PASSWORD: string;
		ALLOW_ADMIN_HEADER_TOKEN: string;
		ALLOW_INSECURE_ADMIN_COOKIE_SECRET: string;
		ADMIN_EMAIL: string;
		ADMIN_COOKIE_SECRET: string;
		ADMIN_ROLE: string;
		ORCH_TOKEN: string;
		CF_API_TOKEN: string;
		CF_API_TOKEN2: string;
		CF_USER_TOKEN: string;
		CF_ACCOUNT_API_VOICETOWEBSITE: string;
		GH_TOKEN: string;
		GH_BOT_TOKEN: string;
		PERSONAL_ACCESS_TOKEN_API: string;
		GH_REPO: string;
		GH_BASE_BRANCH: string;
		OPENAI_API: string;
		OPENAI_API_KEY3: string;
		OPENAI_MODEL: string;
		VITE_GEMINIAPIKEY2: string;
		VITE_GEMINI_MODEL: string;
		PAYPAL_CLIENT_ID: string;
		PAYPAL_CLIENT_SECRET: string;
		PAYPAL_CLIENT_ID_PROD: string;
		PAYPAL_CLIENT_SECRET_PROD: string;
		PAYPAL_ENV: string;
		VITE_PAYPAL_CLIENT_ID: string;
		PAYPAL_PAYMENT_LINK_STARTER: string;
		PAYPAL_PAYMENT_LINK_GROWTH: string;
		PAYPAL_PAYMENT_LINK_ENTERPRISE: string;
		PAYPAL_PAYMENT_LINK_LIFETIME: string;
		PAYPAL_PAYMENT_LINK_PROJECT_PLANNING_HUB: string;
		PAYPAL_PAYMENT_LINK_WEB_FORGE: string;
		PAYPAL_PAYMENT_LINK_AI_DRIVE: string;
		PAYPAL_PAYMENT_LINK_GOOGLE_PROMPTS: string;
		STRIPE_PUBLIC: string;
		STRIPE_PUBLISHABLE_KEY: string;
		STRIPE_SECRET_KEY: string;
		STRIPE_ALLOW_CUSTOM_AMOUNT: string;
		...
		STRIPE_PAYMENT_LINK_GROWTH: string;
		STRIPE_PAYMENT_LINK_ENTERPRISE: string;
		STRIPE_PAYMENT_LINK_LIFETIME: string;
		STRIPE_BUY_BUTTON_ID_STARTER: string;
		STRIPE_BUY_BUTTON_ID_GROWTH: string;
		STRIPE_BUY_BUTTON_ID_ENTERPRISE: string;
		STRIPE_BUY_BUTTON_ID_LIFETIME: string;
		RESEND_API_KEY: string;
		SENDGRID_API_KEY: string;
		DEMO_EMAIL_FROM: string;
		...
		ADSENSE_MAX_SLOTS: string;
		CF_DEPLOY_HOOK_URL: string;
		CF_PAGES_DEPLOY_HOOK: string;
		LICENSE_SECRET: string;
		BOT_HUB: DurableObjectNamespace<import("./worker").BotHubDO>;
		DEPLOY_CONTROLLER: DurableObjectNamespace<import("./worker").DeployControllerDO>;
		LIVE_ROOM: DurableObjectNamespace<import("./worker").LiveRoomDO>;
		AUDIT_LOG: DurableObjectNamespace<import("./worker").AuditLogDO>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PUBLIC_GENERATE" | "CF_ALLOW_LEGACY_DEPLOY_HOOKS" | "ADSENSE_CUSTOMER_ID" | "ADSENSE_ALLOW_ALL_PAGES" | "CACHE_CONTROL_STATIC" | "CACHE_CONTROL_HTML" | "CF_WORKERS_BUILDS_AUTO_DEPLOY" | "ALLOW_REMOTE_DEPLOY_TRIGGER" | "VOICETOWEBSITE_WORKERS_BUILD_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "CF_ZONE_ID" | "CONTROL_PASSWORD" | "ALLOW_ADMIN_HEADER_TOKEN" | "ALLOW_INSECURE_ADMIN_COOKIE_SECRET" | "ADMIN_EMAIL" | "ADMIN_COOKIE_SECRET" | "ADMIN_ROLE" | "ORCH_TOKEN" | "CF_API_TOKEN" | "CF_API_TOKEN2" | "CF_USER_TOKEN" | "CF_ACCOUNT_API_VOICETOWEBSITE" | "GH_TOKEN" | "GH_BOT_TOKEN" | "PERSONAL_ACCESS_TOKEN_API" | "GH_REPO" | "GH_BASE_BRANCH" | "OPENAI_API" | "OPENAI_API_KEY3" | "OPENAI_MODEL" | "VITE_GEMINIAPIKEY2" | "VITE_GEMINI_MODEL" | "PAYPAL_CLIENT_ID" | "PAYPAL_CLIENT_SECRET" | "PAYPAL_CLIENT_ID_PROD" | "PAYPAL_CLIENT_SECRET_PROD" | "PAYPAL_ENV" | "VITE_PAYPAL_CLIENT_ID" | "PAYPAL_PAYMENT_LINK_STARTER" | "PAYPAL_PAYMENT_LINK_GROWTH" | "PAYPAL_PAYMENT_LINK_ENTERPRISE" | "PAYPAL_PAYMENT_LINK_LIFETIME" | "PAYPAL_PAYMENT_LINK_PROJECT_PLANNING_HUB" | "PAYPAL_PAYMENT_LINK_WEB_FORGE" | "PAYPAL_PAYMENT_LINK_AI_DRIVE" | "PAYPAL_PAYMENT_LINK_GOOGLE_PROMPTS" | "STRIPE_PUBLIC" | "STRIPE_PUBLISHABLE_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_ALLOW_CUSTOM_AMOUNT" | "STRIPE_PAYMENT_METHOD_TYPES" | "STRIPE_PRICE_STARTER" | "STRIPE_PRICE_GROWTH" | "STRIPE_PRICE_ENTERPRISE" | "STRIPE_PRICE_LIFETIME" | "STRIPE_PAYMENT_LINK_STARTER" | "STRIPE_PAYMENT_LINK_GROWTH" | "STRIPE_PAYMENT_LINK_ENTERPRISE" | "STRIPE_PAYMENT_LINK_LIFETIME" | "STRIPE_BUY_BUTTON_ID_STARTER" | "STRIPE_BUY_BUTTON_ID_GROWTH" | "STRIPE_BUY_BUTTON_ID_ENTERPRISE" | "STRIPE_BUY_BUTTON_ID_LIFETIME" | "RESEND_API_KEY" | "SENDGRID_API_KEY" | "DEMO_EMAIL_FROM" | "ADSENSE_PUBLISHER" | "ADSENSE_SLOT" | "ADSENSE_MODE" | "ADSENSE_SLOT_TOP" | "ADSENSE_SLOT_MID" | "ADSENSE_SLOT_BOTTOM" | "ADSENSE_MAX_SLOTS" | "CF_DEPLOY_HOOK_URL" | "CF_PAGES_DEPLOY_HOOK" | "LICENSE_SECRET">> {}
}
